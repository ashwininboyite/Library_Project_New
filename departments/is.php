     ...
     <ul class="nav navbar-nav navbar-right">
		...
		<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $_SESSION['stu_username']?><b class="caret"></b></a>
            <ul class="dropdown-menu">
                <li><a href="index.php"><?php session_destroy(); ?><i class="glyphicon glyphicon-log-out pull-right" name="logout"></i> Logout</a></li>
		...
		<div class="container">
			<div class="row" style="margin-top: 5em;">
				<div class="col-md-12 text-center">
					<h1 id="fh5co-logo" class="cursive-font"><a href="is.php">INFORMATION SCIENCE</a></h1>
				</div>
			</div>
			<div class="row">
