		...
		<div class="container">
			<div class="row" style="margin-top: 5em;">
				<div class="col-md-12 text-center">
					<h1 id="fh5co-logo" class="cursive-font"><a href="math.php">MATHEMATICS</a></h1>
				</div>
			</div>
			<div class="row">
              ...
              <div class="about-info text-center">  
				...
				<div class="row">
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div id="div_1" class="img-aspect-16-9"style="height: 310px" >
					...
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div id="div_2" class="img-aspect-16-9" style="height: 310px">
                             <img id="img_2" style="height: 310px"/></div>
      						<div class="caption">
					...
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div id="div_3" class="img-aspect-16-9" style="height: 310px">
                            <img id="img_3" style="height: 310px"/></div>
      						<div class="caption">
					...
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div id="div_4" class="img-aspect-16-9" style="height: 310px">
                             <img id="img_4" style="height: 310px"/></div>
      						<div class="caption">
				...
				<div class="row">
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div id="div_5" class="img-aspect-16-9" style="height: 310px">
                             <img id="img_5" style="height: 310px"/></div>
      						<div class="caption">
	        					<p>Book Name:<samp id="id_5_Book_name"></samp></p>
                                <p>Total Copies: <samp id="id_5_total"></samp></p>
                                <p>Available Copies: <samp id="id_5_available"></samp></p>
                                <p>Book Author: <samp id="id_5_book_author"></samp></p>
                                <p>Published Year: <samp id="id_5_published_year"></samp></p>
                                <p>Edition: <samp id="id_5_edition"></samp></p>
                            </div>
					...
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div id="div_6" class="img-aspect-16-9" style="height: 310px">
                             <img id="img_6" style="height: 310px"/></div>
      						<div class="caption">
	        			        <p>Book Name:<samp id="id_6_Book_name"></samp></p>
                                <p>Total Copies: <samp id="id_6_total"></samp></p>
                                <p>Available Copies: <samp id="id_6_available"></samp></p>
                                <p>Book Author: <samp id="id_6_book_author"></samp></p>
                                <p>Published Year: <samp id="id_6_published_year"></samp></p>
                                <p>Edition: <samp id="id_6_edition"></samp></p>
                            </div>
                        </div>
                    <br/>
      					</div>
					...
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div id="div_7" class="img-aspect-16-9" style="height: 310px">
                             <img id="img_7" style="height: 310px"/></div>
      						<div class="caption">
	        					<p>Book Name:<samp id="id_7_Book_name"></samp></p>
                                <p>Total Copies: <samp id="id_7_total"></samp></p>
                                <p>Available Copies: <samp id="id_7_available"></samp></p>
                                <p>Book Author: <samp id="id_7_book_author"></samp></p>
                                <p>Published Year: <samp id="id_7_published_year"></samp></p>
                                <p>Edition: <samp id="id_7_edition"></samp></p>
					...
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div id="div_8" class="img-aspect-16-9" style="height: 310px">
                            <img id="img_8" style="height: 310px"/></div>
      						<div class="caption">
	        					<p>Book Name:<samp id="id_8_Book_name"></samp></p>
                                <p>Total Copies: <samp id="id_8_total"></samp></p>
                                <p>Available Copies: <samp id="id_8_available"></samp></p>
                                <p>Book Author: <samp id="id_8_book_author"></samp></p>
                                <p>Published Year: <samp id="id_8_published_year"></samp></p>
                                <p>Edition: <samp id="id_8_edition"></samp></p>
