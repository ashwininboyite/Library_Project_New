		...
		<div class="container">
			<div class="row" style="margin-top: 5em;">
				<div class="col-md-12 text-center">
					<h1 id="fh5co-logo" class="cursive-font"><a href="cs.php">COMPUTER SCIENCE</a></h1>
				</div>
			</div>
			<div class="row">
              ...
              <div class="about-info text-center">  
				...
				<div class="row">
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div class="img-aspect-16-9" style="height: 310px">
                                <img id="img_5" style=" height: 310px"/>
                            </div>
      						<div class="caption">
					...
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div class="img-aspect-16-9" style="height: 310px">
                                <img id="img_6" style=" height: 310px"/>
                            </div>
      						<div class="caption">
					...
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div class="img-aspect-16-9" style="height: 310px">
                                <img id="img_7" style=" height: 310px"/>
                            </div>
      						<div class="caption">
					...
					<div class="col-md-3 animate-box">
						<div class="thumbnail">
      						<div class="img-aspect-16-9" style="height: 310px">
                                <img id="img_8" style=" height: 310px"/>
                            </div>
      						<div class="caption">
